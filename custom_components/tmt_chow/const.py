...
OURANOS_STATUS_POLL_SECONDS: Final = 15
OURANOS_STATUS_FAILURE_RETRY_SECONDS: Final = 60
OURANOS_STATUS_AVAILABILITY_SECONDS: Final = 15 * 60
OURANOS_POLLERS_DATA_KEY: Final = f"{DOMAIN}_ouranos_pollers"
