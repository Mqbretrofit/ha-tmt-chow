...
_WIRE_KEYS: Final = (
    "func_system_learn_method", "func_open_over_current", "func_close_over_current",
    "func_open_speed", "func_close_speed", "function_slow_speed_setting",
    "func_slow_down_point", "func_open_delay", "func_close_delay",
    "func_auto_closing", "func_photocell", "func_pedestrian_mode",
    "function_alert_light", "func_ph1", "func_ph2", "func_alarm_buzzer",
    "func_electronic_locker", "func_led_direction", "func_single_door",
...
RAW_PARAMETERS: Final = tuple(
    ("n", f"ps21050d_raw_{index:02d}", None, 4, 0, 0, 0, 255,
     None, None, None, 0, 255, 1, 1.0, None, None)
...
def _current_spec(values: Sequence[int] | None) -> tuple:
    motor_mode = int(values[0]) if values else int(APP_PARAMETERS[0][5] or 0)
